...
<div class="container primary-content">
	...
	<div class="primary-content-heading clearfix">
		...
		<div class="sticky-content pull-right">
			...
			<!-- <button type="button" class="btn btn-default btn-sm btn-quick-task" data-toggle="modal" data-target="#quick-task-modal"><i class="fa fa-file-add"></i> UPLOAD</button> -->
		    <br>
            <br>
		</div>
		<!-- quick task modal -->
		<div class="modal fade" id="quick-task-modal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
                    ...
                    <h4 class="modal-title" id="myModalLabel">UPLOAD REVIEWS</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
					<div class="modal-body">
						<form method="POST" action="upload-review.php" enctype="multipart/form-data" class="form-horizontal" role="form">
							<div class="form-group">
								<div class="col-sm-12">
                <label for="task-title">Review File</label>
                  <input type="file" id="myreview" name="myreview">
								</div>
							</div>
							...
							<div class="col-sm-12">
                                <input type="hidden" class="form-control" name="id" value="<?php  echo $row['id']; ?>"></input>
							...
							<button type="submit" name="UploadReview" class="btn btn-primary">Save</button>
                            </div>
							</div>
						</form>
					</div>
	...
	<div class="row">
		<div class="col-md-8">
			<div class="project-section general-info">
				<h3>General Info</h3>
				<button type="button" class="btn btn-default btn-sm btn-quick-task pull-right" data-toggle="modal" data-target="#quick-task-modal"><i class="fa fa-file-alt"></i> Upload Review</button>
		...
		<div class="col-md-4">
			...
			<div class="widget">
				<div class="widget-header clearfix">
					<h3><i class="fa fa-document"></i> <span>CLIENT PROJECT FILE</span></h3>
			...
			<div class="widget">
				<div class="widget-header clearfix">
					<h3><i class="fa fa-document"></i> <span>ENGINEER PROJECT FILE</span></h3>
					<div class="btn-group widget-header-toolbar">
						<a href="#" title="Expand/Collapse" class="btn btn-link btn-toggle-expand"><i class="fa fa-ios-arrow-up"></i></a>
						<a href="#" title="Remove" class="btn btn-link btn-remove"><i class="fa fa-ios-close-empty"></i></a>
					</div>
				...
				<div class="widget-content">
					<ul class="fa-ul recent-file-list">
						<li><i class="fa-li fa fa-file-pdf-o"></i><a target="_blank" href="">[DRAFT] No File</a></li>
					</ul>
				</div>
			</div>
			<!-- END RECENT FILES -->
